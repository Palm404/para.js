import type { OAuthBody, Session } from './interfaces';
import { checkPermissions } from '../utils/util';
import type { DiscordUser } from '../typings/discord';
import type {
...
// This is not my code, it belongs to https://github.com/sapphiredev/plugins/blob/main/packages/api
