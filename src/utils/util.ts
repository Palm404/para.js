import type { TransformedAutoResponse } from './interfaces';
import type { AutoResponsePayload } from '../typings/responses';
...
export function transformPayload(
  body: AutoResponsePayload | TransformedAutoResponse
) {
